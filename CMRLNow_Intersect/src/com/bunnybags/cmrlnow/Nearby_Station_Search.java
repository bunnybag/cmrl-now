...
public class Nearby_Station_Search extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*ArrayAdapter<String> nearby_station_summary_adapter = new ArrayAdapter<String>(this,  
			    android.R.layout.simple_list_item_1, station_list);  

		nearby_station_summary_adapter.setDropDownViewResource(android.R.layout.simple_list_item_1);
